...
|3|`各时刻详细信息`<br>详细健康信息与建议界面，系统为用户的健康指标进行打分，并在底部为用户提供了相应建议|<img src="https://raw.githubusercontent.com/perfwxc/CoolCar/master/release/pics/各时刻信息+建议.jpg" height=400>)
